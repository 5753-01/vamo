...
const SlideRenderer: React.FC<SlideRendererProps> = ({
  ...
  switch (slideIndex) {
    // ---------------------------------------------------------
    // SLIDE 1: PORTADA OFICIAL (KIT VISUAL INTEGRAL)
    // ---------------------------------------------------------
    case 1:
      return (
        <div className="relative text-white min-h-[560px] flex flex-col justify-between overflow-hidden select-none bg-slate-950">
          {/* Official High-Resolution Highway Sunset & Metallic Shield Background */}
          <div className="absolute inset-0 z-0">
            <img
              src={executiveCoverImg}
              alt="Blindaje Vial 360 Presentación Ejecutiva"
              className="w-full h-full object-cover"
            />
            {/* Dark glass gradient overlay for impeccable typography contrast */}
            <div className="absolute inset-0 bg-gradient-to-t from-slate-950/95 via-slate-950/50 to-slate-950/80" />
          </div>

          {/* Top Bar with Client Brand Badge and Security Level */}
          <div className="relative z-10 p-6 sm:p-8 flex items-center justify-between">
            <div className="flex items-center gap-3 bg-slate-900/90 backdrop-blur-md border border-slate-700/80 px-4 py-2 rounded-2xl shadow-xl">
              <div className="w-3 h-3 rounded-full bg-rose-500 animate-pulse" />
              <div>
                <span className="text-xs font-mono font-bold text-slate-400 block leading-none">MANDANTE / CLIENTE</span>
                <span className="text-sm font-extrabold text-white tracking-wide">
                  {currentCompany.businessName || 'RedPuerto S.A.'}
                </span>
              </div>
            </div>

            <div className="flex items-center gap-2">
              <span className="bg-blue-600/90 backdrop-blur-md text-white text-[11px] font-mono font-bold px-3 py-1.5 rounded-xl border border-blue-400/40 shadow-lg">
                ESTRICTAMENTE CONFIDENCIAL
              </span>
              <span className="bg-slate-900/90 backdrop-blur-md text-cyan-300 text-[11px] font-mono font-bold px-3 py-1.5 rounded-xl border border-cyan-500/30">
                DICTAMEN SUSESO 92064-2025
              </span>
            </div>
          </div>

          {/* Center Main Presentation Title & Taglines */}
          <div className="relative z-10 px-8 sm:px-14 my-auto space-y-4">
            <div className="space-y-1">
              <h1 className="text-3xl sm:text-5xl lg:text-6xl font-black text-white tracking-tight drop-shadow-lg font-sans">
                Blindaje Vial 360
              </h1>
              <p className="text-2xl sm:text-3xl lg:text-4xl italic font-serif text-blue-200 tracking-wide font-medium drop-shadow-md">
                Presentación Ejecutiva
              </p>
            </div>

            <div className="space-y-1.5 pt-2 max-w-2xl">
              <div className="text-lg sm:text-xl font-bold text-cyan-300 flex items-center gap-2">
                <span className="w-2 h-2 rounded-full bg-cyan-400" />
                <span>Seguridad Operacional Inteligente</span>
              </div>
              <p className="text-sm sm:text-base text-slate-200 font-medium">
                Control Preventivo de Alcohol y Drogas para Transporte Crítico de Pasajeros y Carga
              </p>
            </div>

            <div className="pt-3 flex items-center gap-2 sm:gap-3 text-xs sm:text-sm font-semibold text-blue-100 flex-wrap">
              <span className="bg-white/10 backdrop-blur-xs px-3.5 py-1 rounded-full border border-white/20">
          ...
          {/* Footer Metadata Matching the Official Brand Kit Card */}
          <div className="relative z-10 p-6 sm:p-8 border-t border-slate-700/80 bg-slate-950/80 backdrop-blur-md flex flex-col sm:flex-row items-center justify-between text-xs text-slate-300 font-mono gap-2">
            <div className="flex items-center gap-2">
              <span className="text-white font-semibold">San Antonio, Región de Valparaíso</span>
              <span>•</span>
              <span>Septiembre 2026</span>
              <span>•</span>
              <span className="text-amber-300 font-bold">Vigencia: 30 días</span>
            </div>

            <div className="text-slate-400 text-[11px]">
              contacto@blindajevial.cl | +56 9 8452 9100 | www.blindajevial.cl
            </div>
          </div>
        </div>
      );
