...
export const DashboardView: React.FC<DashboardViewProps> = ({
  ...
  return (
    <div className="p-6 space-y-6 max-w-7xl mx-auto dashboard-container executive-reports-container">
      ...
      {/* Checklists Pre-Uso Quick Banner */}
      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-5 shadow-lg flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-sm font-bold text-white">
                Plantillas Personalizables de Listas de Chequeo (Checklists Pre-Uso)
              </h3>
            </div>
            <p className="text-xs text-slate-400 mt-0.5">
              Inspección técnica para tractocamiones, camiones aljibe (DS 298), minería 4x4, buses interurbanos y última milla. Bloqueo inmediato por fallas críticas y actas descargables en PDF con logo oficial.
            </p>
          </div>
        </div>
        ...
        <button
          ...
          className="shrink-0 flex items-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-500 text-white rounded-xl text-xs font-bold transition shadow-md shadow-blue-600/20"
        >
          <ClipboardCheck className="w-4 h-4" />
          <span>Gestionar Checklists</span>
        </button>
      </div>
      ...
      <ExecutiveFloatingPdfButton
        reportName="Dashboard Ejecutivo de Prevención y Cumplimiento"
      />
    </div>
  );
};
