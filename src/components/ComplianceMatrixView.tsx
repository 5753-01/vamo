        ...
        <div className="flex items-center gap-2 shrink-0 flex-wrap">
          ...
          <div className="relative inline-flex items-center">
            <button
              ...
              title="Imprimir o guardar PDF de la Matriz Legal"
            >
            ...
            <button
              ...
              className="bg-slate-800 hover:bg-slate-700 text-slate-400 hover:text-amber-300 border border-l-0 border-slate-700 p-2.5 rounded-r-xl transition cursor-pointer"
