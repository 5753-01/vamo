          ...
          <div className="flex items-center gap-2">
            <div className="relative inline-flex items-center">
              <button
                ...
                className="flex items-center gap-1.5 bg-blue-600 hover:bg-blue-500 text-white text-xs font-semibold px-3 py-1.5 rounded-l-lg shadow transition cursor-pointer"
                title="Imprimir acta oficial o guardar como PDF"
              >
              ...
              <button
                ...
                className="bg-blue-700 hover:bg-blue-600 text-blue-200 border-l border-blue-500 px-2 py-1.5 rounded-r-lg shadow transition cursor-pointer"
                title="Consejos para impresión óptima (Gráficos de fondo, A4)"
              ...
              {/* Tooltip on hover */}
              {showTooltip && (
                <div className="absolute right-0 top-full mt-1.5 w-64 bg-slate-950/95 border border-blue-500/40 text-slate-200 text-[11px] rounded-xl p-2.5 shadow-2xl z-50 pointer-events-none animate-in fade-in duration-100">
                  ...
                  <p className="text-slate-300 text-[10px] leading-snug">
                    Para conservar los sellos y colores de aptitud, active <strong>«Gráficos de fondo»</strong> en el diálogo del navegador.
                  </p>
                </div>
              )}
            </div>
